<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DangKyThongTin.aspx.cs" Inherits="BaiTap2.DangKyThongTin" %>
    ...
    <form id="form1" runat="server">
        <div class="w-50 m-auto">
            ...
            <div class="row mb-2">
                ...
                <div class="col-8">
                    <asp:DropDownList ID="ddlTrinhDo" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlTrinhDo_SelectedIndexChanged"></asp:DropDownList>
                </div>
            </div>
             <div class="row mb-2">
                <div class="col-2">
